...
$deliverystaff_id = $_GET['id'];




if(isset($_POST['delivery_staff'])){

    $name = $_POST['name'];
    $username = $_POST['username'];
    $password = $_POST['password'];

    $sql = "UPDATE `delivery_staff` SET `name`='$name',`username`='$username',
    `password`='$password' WHERE deliverystaff_id = $deliverystaff_id";
    $res =$conn->query($sql);

    if($res == TRUE){
        $_SESSION['status'] = "Data Successfully Updated!";
        $_SESSION['code'] = "success";
        header("location: addDeliveryStaff.php");
      ...
      <div class="container">
        ...
        <div class="card">
              ...
              <div class="card-body">
                ...
                <?php 
                        $sql2 = "select * from delivery_staff where deliverystaff_id = '$deliverystaff_id'";
                   ...
                   <form action="" method="post">
                        ...
                        <div class="table-footer">
                            <button type="submit" name="delivery_staff" class="btn btn-primary mt-2 float-right">Update Staff</button>
                            <a href="addDeliveryStaff.php">
