...
$sql = "INSERT INTO `walkincustomer`(`name`)
 VALUES ('$name')";
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="addWalkinCustomer.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
              <div class="card-header">
                <h3 class="card-title font-weight-bold mt-1">WALK-IN CUSTOMER LIST</h3>
              ...
              <div class="card-body">
                <table id="example2" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    <?php
                    $sql = "select * from walkincustomer";
                    $res =$conn->query($sql);
                  ...
                  <tr>
                    ...
                    <!-- <a class="btn btn-sm btn-warning" href="updateWalkinCustomer.php?id=<?php echo $row['customer_id']; ?>"><i class="fas fa-edit"></i> Edit</a> -->
