...
if (isset($_GET['id'])) {
  ...
  if (isset($_POST['update_inventory'])) {
    ...
    $sql = "UPDATE `inventory` SET `item`='$item',`stock`='$stock',
        `brand`='$brand', `unit`='$unit' WHERE inv_id = '$inv_id'";
    ...
    <div class="container">
      ...
      <div class="card">
        <div class="card-header" style="background: linear-gradient(82deg, rgba(2,0,36,1) 0%, rgba(9,9,40,1) 33%, rgba(53,141,159,1) 100%);">
          <h3 class="card-title font-weight-bold mt-1 text-white">UPDATE ITEM</h3>
        ...
        <div class="card-body">
            ...
            ?>
              <form action="" method="post">
                ...
                <tr>
                  ...
                  <td><input class="form-control" name="stock" type="text" value="<?php echo $row['stock'] ?>"></td>
                </tr>
                <tr>
                  <td class="col-2 text-center font-weight-bold">SELECT UNIT:</td>
                  <td>
          ...
          <div class="table-footer">
            <button type="submit" name="update_inventory" class="btn btn-primary mt-2 float-right pl-4 pr-4">Update</button>
