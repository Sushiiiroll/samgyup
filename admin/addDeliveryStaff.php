...
if(isset($_POST['id'])){
$deliverystaff_id = $_POST['id'];

    $sql = "DELETE FROM delivery_staff where deliverystaff_id = $deliverystaff_id ";
    $res =$conn->query($sql);
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addDeliveryStaff.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Delivery Staff</p>
                </a>
              </li>
      ...
      <div class="container-fluid">
        ...
        <div class="card">
              <div class="card-header">
                <h3 class="card-title font-weight-bold mt-1">DELIVERY STAFF</h3>

               
                <button class="btn btn-outline-primary float-right" data-toggle="modal" data-target="#exampleModal"><i class="fa-solid fa-plus"></i> Add Delivery Staff</button>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a class="btn btn-sm btn-warning" href="updateDeliveryStaff.php?id=<?php echo $row['deliverystaff_id']; ?>"><i class="fas fa-edit"></i> Edit</a>
                    <a class="btn btn-sm btn-danger delete" data-id="<?php echo $row['deliverystaff_id']; ?>" onclick="confirmDelete(this);" >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-white" style="background: linear-gradient(82deg, rgba(2,0,36,1) 0%, rgba(9,9,40,1) 33%, rgba(53,141,159,1) 100%);">
        <h5 class="modal-title" id="exampleModalLabel">ADD DELIVERY STAFF</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="add_deliveryStaff" class="btn btn-primary">Add</button>
      </div>
      </form>
    </div>
  </div>
