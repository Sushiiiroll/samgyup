  ...
  <div class="content">
    <div class="container-fluid">
      <div class="alert alert-info" role="alert">
        <i class="fa-solid fa-circle-info"></i> This table shows the information of ONLINE CUSTOMER registered in the MOBILE APPLICATION!
      </div>
      <div class="card">
        <div class="card-header">
          <h3 class="card-title font-weight-bold mt-1">ONLINE CUSTOMER</h3>
        ...
        <div class="card-body">
          <table id="example2" class="table table-striped table-bordered">
            ...
            <tbody>
              <?php
              $sql = "select * from onlinecustomer";
              $res = $conn->query($sql);
              ...
              ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-sm btn-warning" href="updateOnlineCustomer.php?id=<?php echo $row['customer_id']; ?>"><i class="fas fa-edit"></i> Edit</a>
                    <a class="btn btn-sm btn-danger delete" data-id="<?php echo $row['customer_id']; ?>" onclick="confirmDelete(this);">
