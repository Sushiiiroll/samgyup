    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title font-weight-bold mt-1">STORE STAFF</h3>


          <button class="btn btn-outline-primary float-right" data-toggle="modal" data-target="#exampleModal"><i class="fa-solid fa-plus"></i> Add Staff</button>
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><input type="password" value="<?php echo $row['password'] ?>" style="border: none; width: 100px" disabled></td>
                  
                  <td><?php echo $row['usertype'] ?></td>
                  <td><?php echo $row['date_created'] ?></td>

                  <td class="text-center">
                    <a class="btn btn-sm btn-warning" href="updateStaff.php?id=<?php echo $row['account_id']; ?>"><i class="fas fa-edit"></i> Edit</a>
                    <a class="btn btn-sm btn-danger delete" data-id="<?php echo $row['account_id']; ?>" onclick="confirmDelete(this);">
      ...
      <div class="modal-body">
        <form action="../controller/process.php" method="post">
          ...
          <div class="form-group">
            <label Class="text-secondary">Staff Type:</label>
