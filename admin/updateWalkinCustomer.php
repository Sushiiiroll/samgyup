...
if (isset($_POST['update_customer'])) {
  ...
  $sql = "UPDATE `walkincustomer` SET `name`='$name',`address`='$address',
    `contact_num`='$contact_num' WHERE customer_id = $customer_id";
  $res = $conn->query($sql);

  if ($res == TRUE) {
    $_SESSION['status'] = "Data Successfully Updated!";
    $_SESSION['code'] = "success";
    header("location: addWalkinCustomer.php");
  }
}
            ...
            ?>
              <form action="" method="post">
                ...
                <tr>
                  ...
                  <td><input class="form-control" name="contact_num" type="text" value="<?php echo $row['contact_num'] ?>"></td>
                </tr>
