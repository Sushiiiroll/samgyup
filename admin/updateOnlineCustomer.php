...
if (isset($_POST['update_customer'])) {
  ...
  $sql = "UPDATE `onlinecustomer` SET `name`='$name',`address`='$address',
    `contact_number`='$contact_number', email = '$email' WHERE customer_id = $customer_id";
  $res = $conn->query($sql);

  if ($res == TRUE) {
    $_SESSION['status'] = "Data Successfully Updated!";
    $_SESSION['code'] = "success";
    header("location: onlineCustomer.php");
  }
}
  ...
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item menu-open">
      ...
      <ul class="nav nav-treeview">
        ...
        <li class="nav-item">
          <a href="onlineCustomer.php" class="nav-link active">
            <i class="far fa-circle nav-icon"></i>
            <p> Online Customer</p>
          </a>
        </li>
    ...
    <div class="container">
      ...
      <div class="card">
        <div class="card-header" style="background: linear-gradient(82deg, rgba(2,0,36,1) 0%, rgba(9,9,40,1) 33%, rgba(53,141,159,1) 100%);">
          <h3 class="card-title font-weight-bold mt-1 text-white">UPDATE CUSTOMER</h3>
        ...
        <div class="card-body">
          <table id="example2" class="table table-bordered">
            ...
            <?php
            $sql2 = "select * from onlinecustomer where customer_id = '$customer_id'";
            ...
            ?>
              <form action="" method="post">
                ...
                <tr>
                  <td class="col-2 text-center font-weight-bold">EMAIL:</td>
                  <td><input class="form-control" name="email" type="email" value="<?php echo $row['email'] ?>"></td>
                </tr>
                <tr>
                  <td class="col-2 text-center font-weight-bold">ADDRESS:</td>
                  <td><input class="form-control" name="address" type="text" value="<?php echo $row['address'] ?>"></td>
                </tr>
                <tr>
                  <td class="col-2 text-center font-weight-bold">CONTACT NUMBER:</td>
                  <td><input class="form-control" name="contact_number" type="text" value="<?php echo $row['contact_number'] ?>"></td>
                </tr>

              <?php } ?>
          </table>
          <div class="table-footer">
            <button type="submit" name="update_customer" class="btn btn-primary mt-2 float-right">Update Customer</button>
            <a href="onlineCustomer.php">
