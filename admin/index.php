  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="index.php" class="nav-link">
            <h4 class="font-weight-bold text-dark">ZAMJY RESTAURANT MANAGEMENT SYSTEM</h4>
          </a>
        </li>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./manageNotifications.php" role="button">
            <i class="far fa-bell"></i>
            <?php $getNotif = "SELECT * FROM notification WHERE isRead='NO'";

            if ($result = mysqli_query($conn, $getNotif)) {
            ...
            <span class="badge badge-warning navbar-badge"><?php echo $rowcount ?></span>
          </a>
        </li>
        <li class="nav-item">
