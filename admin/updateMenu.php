      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            ?>
              <form action="" method="post">
                ...
                <tr>
                  ...
                  <td class="col-2 text-center font-weight-bold">DESCRIPTION:</td>
                  <td><textarea class="form-control mb-2" placeholder="Description" name="description" rows="5" required><?php echo $row['description'] ?></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="col-2 text-center font-weight-bold">STOCK:</td>
                  <td><input class="form-control" name="stock" type="number" value="<?php echo $row['stock'] ?>"></td>
                </tr>
          ...
          <div class="table-footer">
            ...
            <button type="submit" name="delete_menu" class="btn btn-danger mt-2 float-right">Delete</button>
            <a href="manageMenu.php">
              <input type="button" class="btn btn-secondary mt-2 float-right mr-3" value="Cancel"></a>
          </div>
