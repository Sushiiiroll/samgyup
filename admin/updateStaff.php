            ...
            ?>
              <form action="" method="post">
                ...
                <tr>
                  ...
                  <td><input class="form-control" name="username" type="text" value="<?php echo $row['username'] ?>" disabled></td>
                </tr>
                <tr>
                  <td class="col-2 text-center font-weight-bold">PASSWORD:</td>
                  <td><input class="form-control" name="password" type="password" value="<?php echo $row['password'] ?>" disabled></td>
                </tr>
