...
<nav class="mt-2">
  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <li class="nav-item menu-open">
      ...
      <ul class="nav nav-treeview">
        <li class="nav-item">
          <a href="walkinOrder.php" class="nav-link active">
            <i class="far fa-circle nav-icon"></i>
            <p> Walk-In Order</p>
          </a>
        </li>
    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title font-weight-bold mt-1">WALKIN ORDERS</h3>
        ...
        <div class="card-body">
          <table id="example2" class="table table-striped table-bordered">
            ...
            <tbody>
              <?php
              // $sql = "select * from walkin_orders";
              $sql = "SELECT m.menu, m.price, o.quantity, o.order_date, o.order_number, o.order_id
                      FROM menu AS m
              ...
              ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-sm btn-warning" href="updateOnlineCustomer.php?id=<?php echo $row['order_id']; ?>"><i class="fas fa-edit"></i> Edit</a>
